...
public class SectionedRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private RecyclerView.ViewHolder getItemViewHolder(ViewGroup parent, Section section) {
        ...
        //if(section.getItemType().equals("units")){
            view = LayoutInflater.from(parent.getContext()).inflate(section.getItemResourceId(),
                    parent, false);
        //}

        /*if(section.getItemType().equals("bundles")){
            view = LayoutInflater.from(parent.getContext()).inflate(section.getItemResourceIdBundles(),
                    parent, false);
        }*/
