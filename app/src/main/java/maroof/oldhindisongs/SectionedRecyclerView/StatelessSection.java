...
public abstract class StatelessSection extends Section {
    ...
    /**
     * Create a Section object with loading/failed states, a custom header and footer and second resource
     * @param headerResourceId layout resource for its header
     * @param footerResourceId layout resource for its footer
     * @param itemResourceId layout resource for its items
     */
    public StatelessSection(int headerResourceId, int footerResourceId, int itemResourceId, int itemResourceId1, String type) {
        this(headerResourceId, itemResourceId);
        this.footerResourceId = footerResourceId;
        this.hasFooter = true;
        this.itemResourceBundleId = itemResourceId1;
        this.itemType = type;
    }
