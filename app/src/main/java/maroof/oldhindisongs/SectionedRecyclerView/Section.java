package maroof.oldhindisongs.SectionedRecyclerView;

import android.support.v7.widget.RecyclerView;
import android.view.View;

/**
 * Created by Maroof on 4/19/2017.
 */

public abstract class Section {
    public enum State { LOADING, LOADED, FAILED}

    private Section.State state = State.LOADED;
     ...
     */
    public final void setState(Section.State state) {
        this.state = state;
    }
     ...
     */
    public final Section.State getState() {
        return state;
    }
    ...
    public final int getItemResourceIdBundles() {
        return itemResourceBundleId;
    }

    public final String getItemType () {return itemType;}
    /**
