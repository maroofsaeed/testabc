...
public class NewsAdapter extends ArrayAdapter<Categories> {
    ...
    public NewsAdapter(Context _context, List<Categories> _mylist) {
        super(_context, R.layout.list_item_news, _mylist);
        this.mylist = _mylist;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = vi.inflate(R.layout.list_item_news, parent, false);
